        ...
        while True:
            ...
            try:
                ...
                if payload.get("event") == "telemetry":
                    ...
                    await manager.send_personal_message(json.dumps({"status": "received", "event": "ack"}), device_id)
...
async def push_to_device(device_id: str, payload: dict):
    ...
    if not success:
        raise HTTPException(status_code=404, detail="Device not connected to this relay node")
